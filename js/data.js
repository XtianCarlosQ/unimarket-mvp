const UM_DATA = {
  currentUser: {
    ...
    avatar: "assets/avatars/valeria.svg",
    verified: true,
    rating: 4.9,
    sales: 18,
    purchases: 23,
  ...
  sellers: [
    { id:"s1", name:"Tejido Amor", faculty:"Facultad de Letras", avatar:"assets/avatars/tejido.svg", rating:4.93, verified:true, sales:46 },
    { id:"s2", name:"Dulce Universitario", faculty:"Facultad de Medicina", avatar:"assets/avatars/dulce.svg", rating:4.88, verified:true, sales:51 },
    { id:"s3", name:"Fashion UNI", faculty:"Facultad de Ciencias Económicas", avatar:"assets/avatars/fashion.svg", rating:4.72, verified:true, sales:29 },
  ...
  products: [
    { id:"p1", category:"tejidos", sellerId:"s1", name:"Cangrejo tejido 🦀", price:25, image:"assets/products/crab.svg", badge:"Más pedido", description:"Cangrejo tejido a mano con hilo de algodón, ideal para regalo o decoración. Acabado suave, color rosa pastel y entrega coordinada dentro del campus.", place:"Biblioteca Central", schedule:"Lun-Mie-Vie, 1:00 p. m. a 4:30 p. m.", popularity:4.9 },
    { id:"p2", category:"accesorios", sellerId:"s1", name:"Pulsera de perlas", price:15, image:"assets/products/bracelet.svg", badge:"Nuevo", description:"Pulsera artesanal con perlas sintéticas y broche ajustable. Diseño discreto para uso diario o regalo universitario.", place:"Puerta 3", schedule:"Mar-Jue, 10:00 a. m. a 2:00 p. m.", popularity:4.7 },
    ...
    { id:"p4", category:"accesorios", sellerId:"s3", name:"Aretes flor", price:12, image:"assets/products/earrings.svg", badge:"Oferta", description:"Aretes livianos con diseño floral. Incluye empaque básico y entrega coordinada en zonas académicas.", place:"Comedor Universitario", schedule:"Lun-Mie, 2:00 p. m. a 5:00 p. m.", popularity:4.5 },
    { id:"p5", category:"postres", sellerId:"s2", name:"Postre del día", price:8, image:"assets/products/snack.svg", badge:"Dulce", description:"Postre casero del día en presentación individual. Consulta sabor disponible por chat antes de coordinar la entrega.", place:"Facultad de Medicina", schedule:"Todos los días, 11:00 a. m. a 1:00 p. m.", popularity:4.9 },
    { id:"p6", category:"comida", sellerId:"s2", name:"Menú express", price:11, image:"assets/products/lunch.svg", badge:"Rápido", description:"Menú universitario por pedido. Ideal para estudiantes con poco tiempo entre clases.", place:"Comedor Universitario", schedule:"Lun-Vie, 12:00 m. a 2:30 p. m.", popularity:4.6 },
